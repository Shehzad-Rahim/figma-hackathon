...
const ProductsListing = ({ params }: { params: { slug: string } }) => {
  ...
  const { addToCart } = useCart(); // Get addToCart from Context API
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row lg:gap-4 lg:p-20 sm:px-4">
        ...
        {/* Product Details Section */}
        <div className="flex flex-col justify-center gap-3 px-4 sm:pt-0 pt-5 lg:p-20 w-full lg:w-1/2">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
            <div className="flex items-center gap-4">
              <p className="text-sm sm:block ">Amount:</p>
              <div className="flex items-center border bg-gray-400 px-4">
                <button onClick={decrease} className="px-3 py-2 bg-gray-100">
                  -
                </button>
                <p className="px-4 py-2">{count}</p>
